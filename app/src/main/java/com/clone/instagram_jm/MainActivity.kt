package com.clone.instagram_jm
...
import com.clone.instagram_jm.databinding.ActivityMainBinding
    ...
    private fun setBottomNavigation() {
        navController.addOnDestinationChangedListener{_, destination, _ ->
            if(destination.id == R.id.menu_home ||
                ...
                destination.id == R.id.menu_add ||
                destination.id == R.id.menu_relay_story ||
